...
namespace CampusParty.Migrations
{
    ...
    [Migration("20221127031041_InitDBv3")]
            ...
            modelBuilder.Entity("CampusParty.Models.Usuario", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UsuarioId = 1,
                            CiudadId = 1,
                            Contraseña = "$2a$10$LB4qPS7Ca1/rimNtfwWZF.DKCT38oALID/G/6GHROvbGZMvJJDFea",
                            Correo = "admin@gmail.com",
                            Documento = "10001460",
                            FechaNacimiento = new DateTime(2022, 11, 26, 22, 10, 40, 184, DateTimeKind.Local).AddTicks(1527),
